...
// PROJECT INCLUDES
#include "devices/ard/maestro.hpp"
...
MicroMaestro::MicroMaestro(
    ...
    bool CRCEnabled)
  :
    Maestro(stream, resetPin, deviceNumber, CRCEnabled)
{
}
...
void MiniMaestro::setMultiTarget(
    uint8_t numberOfTargets, uint8_t firstChannel, uint16_t *targetList)
{
